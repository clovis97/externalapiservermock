...
urlpatterns = [
    ...
    path('africell/balance/check', AfricellBalanceCheckMockView.as_view(), name='africell-balance-check'),
    path('africell/data/bundle', AfricellDataBundleMockView.as_view(), name='africell-data-bundle'),
